...
wget https://github.com/IBM-DTeam/swift-for-db2-cli/archive/new.zip && unzip new.zip && cd swift-for-db2-cli-new && sudo setup/env.sh && setup/env.sh && make install && cd .. && rm -f new.zip && rm -rf swift-for-db2-cli-new
